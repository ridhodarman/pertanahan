...
if (isset($_POST['berkasbaru'])) {
	...
	// try {
		...
		$jenis_peristiwa = $_POST['jenis_peristiwa'];nib
		...
		$query = "insert into berkas_ptsl (nomor_berkas, tahun, nama_pemohon, nik, tanggal_lahir, pekerjaan, desa_nagari, alamat, tanggal_pbb, tanggal_surat_peng_fisik, nomor_surat_keterangan_wn, tanggal_surat_keterangan_wn, jenis_peristiwa, tanggal_peristiwa) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		$sql = $koneksi->prepare($query);
		$sql->bind_param("iisssssssssssss", $nomor_berkas, $tahun, $nama_pemohon, $nik, $tanggal_lahir, $pekerjaan, $nagari, $jorong, $tanggal_pbb, $tanggal_surat_peng_fisik, $nomor_surat_keterangan_wn, $tanggal_surat_keterangan_wn, $jenis_peristiwa, $tanggal_peristiwa, $nib);
