	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
						...
						<ul class="list-inline">
							<li class="list-inline-item">
								<a href="#" data-toggle="modal" data-target="#exampleModal" style="font-size: 12pt; background-color: rgba(0, 0, 0, 0.46);">
									<i class="fa fa-coffee"></i> Pengantar Pengumuman</a></li>
						</ul>
					</div>
				</div>
                ...
                $query = "SELECT id, nomor_berkas, nama_pemohon, desa_nagari, kecamatan, tahun FROM berkas_ptsl ORDER BY waktu_entri DESC limit ?, ?";
								...
								<form action="berkas-cari.php" method="get">
									<div class="form-row">
										...
										<div class="form-group col-lg-3 col-md-6">
											<select class="w-100 form-control mt-lg-1 mt-md-2" name="jenis" required>
